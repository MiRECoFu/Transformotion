...
from models.transformers.transformotion_trainer import TransformotionTrainer
...
if __name__ == '__main__':
    ...
    # all_params = 0
    # pc_transformer = sum(param.numel() for param in transformotion.parameters_wo_clip())

    # # print(t2m_transformer)
    # # print("Total parameters of t2m_transformer net: {:.2f}M".format(pc_transformer / 1000_000))
    # all_params += pc_transformer

    # print('Total parameters of all models: {:.2f}M'.format(transformotion.parameters / 1000_000))
    ...
    trainer = TransformotionTrainer(opt, transformotion, vq_model)
