...
from utils.eval_rvq import evaluation_vqvae
    ...
    def train(self, train_loader, val_loader, eval_val_loader, eval_wrapper, plot_eval=None):
        ...
        while epoch < self.opt.max_epoch:
            ...
            for i, batch_data in enumerate(train_loader):
                ...
                wandb.log({"perplexity": perplexity, "loss": loss, "loss_rec": loss_rec, "loss_vel": loss_vel, "loss_commit": loss_commit})
            ...
            wandb.log({"Val/loss_perplexity": sum(val_perpexity) / len(val_loss_rec), "Val/loss": sum(val_loss)/len(val_loss), "Val/loss_rec": sum(val_loss_rec) / len(val_loss_rec)})
