...
from data_process.motion_dataset import MotionDataset
...
if __name__ == "__main__":
    ...
    if opt.dataset_name == "t2m":
        ...
        dataset_opt_path = '/root/autodl-tmp/checkpoints/kit/Comp_v6_KLD005/opt.txt'
    else:
