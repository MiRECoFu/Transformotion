...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--name', type=str, default="trm_xl_b64_d1024_716_clip_nh16_nl18_downt_1——wd0.01", help='Name of this trial')

        self.parser.add_argument('--vq_name', type=str, default="rvq_down_t_1", help='Name of the rvq model.')
        ...
        self.parser.add_argument('--n_layers', type=int, default=12, help='Number of attention layers.')
